    ...
    <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="p-5">
        ...
        <div className="flex gap-2">
          ...
          <a
            href={`tel:${marriageGarden.contactInfo?.phone || ''}`}
            className="flex-1 border-2 border-indigo-600 text-indigo-600 py-2 px-4 rounded-md hover:bg-indigo-50 transition font-medium text-center"
          >
            Contact
          </a>
        </div>
