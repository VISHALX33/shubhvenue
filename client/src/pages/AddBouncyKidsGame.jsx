...
const AddBouncyKidsGame = () => {
  ...
  const addGameType = () => {
    if (currentGameType.trim()) {
      setFormData({
        ...formData,
        gameTypes: [...formData.gameTypes, currentGameType.trim()]
      });
      setCurrentGameType('');
    }
  };

  const removeGameType = (index) => {
    setFormData({
      ...formData,
      gameTypes: formData.gameTypes.filter((_, i) => i !== index)
    });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        'http://localhost:5000/api/bouncy-kids-games',
        formData,
        {
          headers: {
      ...
      if (response.data.success) {
        alert('Bouncy Kids Game listing created successfully!');
        navigate('/vendor/listings');
      }
    } catch (error) {
      console.error('Error creating bouncy kids game listing:', error);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Add Bouncy Kids Game</h1>
        
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 space-y-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Bouncy Kids Game Name *
            </label>
            <input
              type="text"
              name="name"
              ...
              placeholder="Enter bouncy kids game name"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="4"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              placeholder="Describe your bouncy kids game services..."
            />
          </div>
...
export default AddBouncyKidsGame;
