  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        'http://localhost:5000/api/costume-dresses',
        formData,
        {
          headers: {
      ...
      if (response.data.success) {
        alert('Costume Dress listing created successfully!');
        navigate('/vendor/listings');
      }
    } catch (error) {
      console.error('Error creating costume dress listing:', error);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Add Costume Dress</h1>
...
export default AddCostumeDress;
