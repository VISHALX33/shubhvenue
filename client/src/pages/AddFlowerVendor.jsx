  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        'http://localhost:5000/api/flower-vendors',
        formData,
        {
          headers: {
      ...
      if (response.data.success) {
        alert('Flower Vendor listing created successfully!');
        navigate('/vendor/listings');
      }
    } catch (error) {
      console.error('Error creating flower vendor listing:', error);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Add Flower Vendor</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 space-y-6">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {formData.flowerTypes.map((flowerType, index) => (
...
export default AddFlowerVendor;
