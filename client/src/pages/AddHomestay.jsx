...
function AddHomestay() {
  ...
  const amenitiesList = [
    'WiFi', 'Parking', 'Kitchen', 'Washing Machine', 'Hot Water',
    'TV', 'AC', 'Heater', 'Garden', 'Terrace',
    'Meals Included', 'Local Guide', 'Bicycle', 'Bonfire', 'Pet Friendly'
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-emerald-100 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-6">Add Homestay</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  <label className="block text-gray-700 font-semibold mb-2">Homestay Name *</label>
                  <input
                    type="text"
                    value={formData.name}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                    placeholder="e.g., Full refund 48 hours before check-in"
                  />
                </div>
            ...
            <div className="flex gap-4 pt-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-gradient-to-r from-teal-500 to-emerald-600 text-white py-3 rounded-lg font-semibold hover:from-teal-600 hover:to-emerald-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
