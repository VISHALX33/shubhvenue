...
function AddHotel() {
  ...
  const amenitiesList = [
    'WiFi', 'Parking', 'Restaurant', 'Room Service', 'Gym',
    'Spa', 'Swimming Pool', 'Conference Room', 'Bar', 'Laundry',
    'Airport Shuttle', 'Concierge', '24/7 Front Desk', 'Business Center', 'Banquet Hall'
  ];
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4 pt-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-gradient-to-r from-amber-500 to-orange-600 text-white py-3 rounded-lg font-semibold hover:from-amber-600 hover:to-orange-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
