  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        'http://localhost:5000/api/ice-cream-counters',
        formData,
        {
          headers: {
      ...
      if (response.data.success) {
        alert('Ice Cream Counter listing created successfully!');
        navigate('/vendor/listings');
      }
    } catch (error) {
      console.error('Error creating ice cream counter listing:', error);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Add Ice Cream Counter</h1>
...
export default AddIceCreamCounter;
