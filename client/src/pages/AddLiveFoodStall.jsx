  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        alert('Live Food Stall listing created successfully!');
        navigate('/vendor/listings');
      }
    } catch (error) {
      console.error('Error creating live food stall listing:', error);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Add Live Food Stall</h1>
...
export default AddLiveFoodStall;
