...
function AddLodge() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Lodge listed successfully!');
  ...
  const amenitiesList = [
    'WiFi', 'Parking', 'Hot Water', 'TV', 'AC',
    'Room Service', 'Laundry', 'Breakfast', 'Kitchen', 'Security',
    'CCTV', 'Caretaker', 'Power Backup', 'Heater', 'Geyser'
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-6">Add Lodge / Guest House</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    placeholder="e.g., Full refund 24 hours before check-in"
                  />
                </div>
            ...
            <div className="flex gap-4 pt-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-gradient-to-r from-purple-500 to-pink-600 text-white py-3 rounded-lg font-semibold hover:from-purple-600 hover:to-pink-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
