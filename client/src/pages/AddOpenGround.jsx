...
function AddOpenGround() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const submitData = {
        ...
        area: {
          size: Number(formData.area.size),
      ...
      alert('Open Ground listed successfully!');
  ...
  const amenitiesList = [
    'Parking', 'Electricity', 'Water Supply', 'Restrooms', 'Security',
    'Lighting', 'Stage Setup', 'Green Room', 'VIP Area', 'Boundary Wall',
    'CCTV', 'Generator', 'Catering Space', 'Storage Room'
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-lime-50 to-green-100 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-6">Add Open Ground</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  <label className="block text-gray-700 font-semibold mb-2">Ground Name *</label>
                  <input
                    type="text"
                    value={formData.name}
                    ...
                    placeholder="Enter open ground name"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lime-500"
                  >
                    <option value="Wedding Ground">Wedding Ground</option>
                    <option value="Corporate Event Ground">Corporate Event Ground</option>
                    ...
                    <option value="Budget Plot">Budget Plot</option>
                  </select>
                </div>

                <div className="md:col-span-2">
                  <h3 className="text-lg font-semibold text-gray-700 mb-3">Ground Area</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setFormData(prev => ({ ...prev, area: { ...prev.area, size: e.target.value } }))}
                        required
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lime-500"
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setFormData(prev => ({ ...prev, area: { ...prev.area, unit: e.target.value } }))}
                        required
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lime-500"
                      >
            ...
            <div>
              ...
              <textarea
                ...
                rows="4"
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lime-500"
                placeholder="Describe your open ground..."
              />
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lime-500"
                    placeholder="e.g., Full refund 15 days before event"
                  />
                </div>
                ...
                <div className="flex gap-6">
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={formData.policies.decorationAllowed}
                      onChange={(e) => setFormData(prev => ({ ...prev, policies: { ...prev.policies, decorationAllowed: e.target.checked } }))}
                      className="w-4 h-4 text-lime-600"
                    />
                    <span className="text-gray-700">Decoration Allowed</span>
                  </label>

                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={formData.policies.tentAllowed}
                      onChange={(e) => setFormData(prev => ({ ...prev, policies: { ...prev.policies, tentAllowed: e.target.checked } }))}
                      className="w-4 h-4 text-lime-600"
                    />
                    <span className="text-gray-700">Tent Allowed</span>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4 pt-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-gradient-to-r from-lime-500 to-green-600 text-white py-3 rounded-lg font-semibold hover:from-lime-600 hover:to-green-700 transition-all duration-300 disabled:opacity-50"
              >
