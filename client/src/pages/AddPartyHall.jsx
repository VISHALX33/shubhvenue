...
function AddPartyHall() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(
        'http://localhost:5000/api/party-halls',
        submitData,
        {
      ...
      alert('Party Hall listed successfully!');
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-6">Add Party Hall</h1>
                ...
                <div className="flex gap-6">
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, policies: { ...prev.policies, dj: e.target.checked } }))}
                      className="w-4 h-4 text-blue-600"
                    />
                    <span className="text-gray-700">DJ Allowed</span>
                  </label>
                </div>
              </div>
            </div>
