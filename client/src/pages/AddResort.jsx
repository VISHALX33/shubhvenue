...
function AddResort() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Resort listed successfully!');
  ...
  const amenitiesList = [
    'Swimming Pool', 'Spa', 'Beach Access', 'Water Sports', 'Gym',
    'Restaurant', 'Bar', 'Kids Club', 'WiFi', 'Parking',
    'Room Service', 'Conference Room', 'Garden', 'Golf Course', 'Yoga Classes'
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-blue-100 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-6">Add Resort</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4 pt-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-gradient-to-r from-cyan-500 to-blue-600 text-white py-3 rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
