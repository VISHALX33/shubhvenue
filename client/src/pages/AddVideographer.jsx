...
function AddVideographer() {
  ...
  const [formData, setFormData] = useState({
    ...
    about: '',
    deliveryTime: '',
    contactInfo: { phone: '', email: '', website: '', whatsapp: '', instagram: '', youtube: '' }
  });
  ...
  const videographerTypes = ['Wedding Videographer', 'Event Videographer', 'Commercial Videographer', 'Corporate Videographer', 'Documentary Videographer', 'Budget Videographer'];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/api/videographers', formData, {
        headers: { Authorization: `Bearer ${token}` }
      });
      if (response.data.success) {
        alert('Videographer listing created successfully!');
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">Add Videographer Service</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="text" name="name" value={formData.name} onChange={handleChange} required className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="e.g., Professional Wedding Videography" />
            </div>
            ...
            <div>
              ...
              <select name="type" value={formData.type} onChange={handleChange} required className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                ...
                {videographerTypes.map(type => <option key={type} value={type}>{type}</option>)}
              </select>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="text" name="deliveryTime" value={formData.deliveryTime} onChange={handleChange} required className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="e.g., 15-20 days" />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <input type="text" value={serviceInput} onChange={(e) => setServiceInput(e.target.value)} className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="e.g., Wedding Film, Highlight Video, Drone Shots" />
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <input type="text" value={equipmentInput} onChange={(e) => setEquipmentInput(e.target.value)} className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="e.g., 4K Camera, Gimbal, Drone, Lighting" />
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <input type="text" value={specializationInput} onChange={(e) => setSpecializationInput(e.target.value)} className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="e.g., Cinematic, Traditional, Documentary" />
          ...
          <div>
            ...
            <textarea name="about" value={formData.about} onChange={handleChange} required rows="4" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="Describe your videography service..." />
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="url" name="contactInfo.youtube" value={formData.contactInfo.youtube} onChange={handleChange} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" />
              </div>
            </div>
          </div>
...
export default AddVideographer;
