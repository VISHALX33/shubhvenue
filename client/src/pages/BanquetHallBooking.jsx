...
function BanquetHallBooking() {
  ...
  const fetchBanquetHalls = async (filterParams = {}) => {
    try {
      setLoading(true);
  ...
  const applyFilters = () => {
    ...
    fetchBanquetHalls(activeFilters);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-4">
          ...
          <p className="text-xl md:text-2xl text-center max-w-3xl">
            Elegant venues for your grand celebrations
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Filter Banquet Halls</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="flex items-end space-x-2 lg:col-span-2">
              <button
                ...
                className="flex-1 bg-indigo-600 text-white px-6 py-2 rounded-lg hover:bg-indigo-700 transition-colors font-semibold"
              >
                Apply Filters
              </button>
              <button
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-800">
            {loading ? 'Loading...' : `${banquetHalls.length} Banquet Halls Found`}
          </h2>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {banquetHalls.map((hall) => (
              <BanquetHallCard key={hall._id} hall={hall} />
            ))}
          </div>
        ) : (
          <div className="bg-white rounded-lg shadow-lg p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">No Banquet Halls Found</h3>
