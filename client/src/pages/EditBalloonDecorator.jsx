...
const EditBalloonDecorator = () => {
  ...
  const [currentBalloonType, setCurrentBalloonType] = useState('');
  ...
  const fetchListing = async () => {
    try {
      ...
      const response = await axios.get(`http://localhost:5000/api/balloon-decorators/${id}`, {
  ...
  const addBalloonType = () => {
    if (currentBalloonType.trim()) {
      setFormData({
        ...formData,
        balloonTypes: [...formData.balloonTypes, currentBalloonType.trim()]
      });
      setCurrentBalloonType('');
    }
  };

  const removeBalloonType = (index) => {
    setFormData({
      ...formData,
      balloonTypes: formData.balloonTypes.filter((_, i) => i !== index)
    });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:5000/api/balloon-decorators/${id}`,
        formData,
        {
          headers: {
      ...
      if (response.data.success) {
        alert('Balloon Decorator listing updated successfully!');
        navigate('/vendor/listings');
      }
    } catch (error) {
      console.error('Error updating balloon decorator listing:', error);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Edit Balloon Decorator</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="Enter balloon decorator business name"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
            >
              {balloonDecoratorTypes.map((type) => (
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              <input
                type="text"
                value={currentBalloonType}
                onChange={(e) => setCurrentBalloonType(e.target.value)}
                className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                placeholder="Add balloon type"
              />
              <button
                type="button"
                onClick={addBalloonType}
                className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
              >
                Add
              </button>
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-4 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handlePackageChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  placeholder="e.g., Full Venue, Stage Area"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
          ...
          <div>
            ...
            <textarea
              ...
              rows="4"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              placeholder="Describe your balloon decoration services..."
            />
          </div>
          ...
          <div className="flex gap-4 pt-6">
            ...
            >
              Update Balloon Decorator Listing
            </button>
            <button
              type="button"
...
export default EditBalloonDecorator;
