...
const EditBouncyKidsGame = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        alert('Bouncy Kids Game listing updated successfully!');
        navigate('/vendor/listings');
      }
    } catch (error) {
      console.error('Error updating bouncy kids game listing:', error);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Edit Bouncy Kids Game</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 space-y-6">
          ...
          <div className="flex gap-4 pt-6">
            ...
            >
              Update Bouncy Kids Game Listing
            </button>
            <button
              type="button"
...
export default EditBouncyKidsGame;
