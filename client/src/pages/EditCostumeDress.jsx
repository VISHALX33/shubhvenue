...
const EditCostumeDress = () => {
  ...
  const fetchListing = async () => {
    try {
      ...
      const response = await axios.get(`http://localhost:5000/api/costume-dresses/${id}`, {
  ...
  const addCollection = () => {
    if (currentCollection.trim()) {
      setFormData({
        ...formData,
        collections: [...formData.collections, currentCollection.trim()]
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:5000/api/costume-dresses/${id}`,
        formData,
        {
          headers: {
      ...
      if (response.data.success) {
        alert('Costume Dress listing updated successfully!');
        navigate('/vendor/listings');
      }
    } catch (error) {
      console.error('Error updating costume dress listing:', error);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Edit Costume Dress</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="Enter costume dress name"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="4"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              placeholder="Describe your costume dress services..."
            />
          </div>
...
export default EditCostumeDress;
