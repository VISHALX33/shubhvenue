...
const EditIceCreamCounter = () => {
  ...
  const fetchListing = async () => {
    try {
      ...
      const response = await axios.get(`http://localhost:5000/api/ice-cream-counters/${id}`, {
  ...
  const addFlavor = () => {
    if (currentFlavor.trim()) {
      setFormData({
        ...formData,
        flavors: [...formData.flavors, currentFlavor.trim()]
      });
      setCurrentFlavor('');
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:5000/api/ice-cream-counters/${id}`,
        formData,
        {
          headers: {
      ...
      if (response.data.success) {
        alert('Ice Cream Counter listing updated successfully!');
        navigate('/vendor/listings');
      }
    } catch (error) {
      console.error('Error updating ice cream counter listing:', error);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Edit Ice Cream Counter</h1>
        
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 space-y-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Ice Cream Counter Name *
            </label>
            <input
              type="text"
              name="name"
              ...
              placeholder="Enter ice cream counter name"
            />
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <input
                type="number"
                name="flavorsAvailable"
                value={formData.flavorsAvailable}
                onChange={handleChange}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                placeholder="Number of flavors"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
          ...
          <div>
            ...
            <textarea
              ...
              rows="4"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              placeholder="Describe your ice cream counter service..."
            />
          </div>
          ...
          <div className="flex gap-4 pt-6">
            ...
            >
              Update Ice Cream Counter Listing
            </button>
            <button
              type="button"
...
export default EditIceCreamCounter;
