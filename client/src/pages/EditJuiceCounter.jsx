...
const EditJuiceCounter = () => {
  ...
  const addVariety = () => {
    if (currentVariety.trim()) {
      setFormData({
        ...formData,
        juiceVarieties: [...formData.juiceVarieties, currentVariety.trim()]
      });
      setCurrentVariety('');
    }
  };
  ...
  const removeVariety = (index) => {
    setFormData({
      ...formData,
      juiceVarieties: formData.juiceVarieties.filter((_, i) => i !== index)
    });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        alert('Juice Counter listing updated successfully!');
        navigate('/vendor/listings');
      }
    } catch (error) {
      console.error('Error updating juice counter listing:', error);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Edit Juice Counter</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="Enter juice counter name"
            />
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {formData.juiceVarieties.map((variety, index) => (
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <input
                type="number"
                name="juicesAvailable"
                value={formData.juicesAvailable}
                onChange={handleChange}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                placeholder="Number of juices"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
          ...
          <div>
            ...
            <textarea
              ...
              rows="4"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              placeholder="Describe your juice counter service..."
            />
          </div>
...
export default EditJuiceCounter;
