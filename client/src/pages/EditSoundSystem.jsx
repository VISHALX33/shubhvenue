...
const EditSoundSystem = () => {
  ...
  const fetchListing = async () => {
    try {
      ...
      const response = await axios.get(`${API_URL}/sound-systems/${id}`, {
  ...
  const addBrand = () => {
    if (currentBrand.trim()) {
      setFormData({
        ...formData,
        brands: [...formData.brands, currentBrand.trim()]
      });
      setCurrentBrand('');
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        alert('Sound System listing updated successfully!');
        navigate('/vendor/listings');
      }
    } catch (error) {
      console.error('Error updating sound system listing:', error);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Update Sound System</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="Enter sound system name"
            />
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              <input
                ...
                placeholder="e.g., Speakers, Mixer, Microphone"
              />
              <button
                type="button"
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              <input
                ...
                className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                placeholder="e.g., Wireless connectivity, Bluetooth"
              />
              <button
                type="button"
                onClick={addFeature}
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              <input
                ...
                className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                placeholder="e.g., JBL, Bose, Yamaha"
              />
              <button
                type="button"
                onClick={addBrand}
            ...
            <div className="flex flex-wrap gap-2">
              {formData.brands.map((item, index) => (
                <span
                  key={index}
                  className="inline-flex items-center gap-1 px-3 py-1 bg-blue-100 text-blue-800 rounded-full"
                >
          ...
          <div>
            ...
            <textarea
              ...
              rows="4"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              placeholder="Describe your sound system service..."
            />
          </div>
...
export default EditSoundSystem;
