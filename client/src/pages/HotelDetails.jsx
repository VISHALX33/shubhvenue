    ...
    return (
      <div className="min-h-screen flex justify-center items-center bg-gradient-to-br from-amber-50 to-orange-100">
        <div className="text-center">
          ...
          <button
            onClick={() => navigate('/venue-hall/hotel')}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 py-8">
      <div className="container mx-auto px-4">
        ...
        <button
          onClick={() => navigate('/venue-hall/hotel')}
          className="flex items-center text-amber-600 hover:text-amber-800 mb-6 font-semibold"
        >
            ...
            {hotel.images.map((image, index) => (
              <img
                ...
                className={`w-full h-24 object-cover rounded cursor-pointer transition-all ${
                  selectedImage === index ? 'ring-4 ring-amber-600' : 'opacity-70 hover:opacity-100'
                }`}
              ...
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <div className="flex items-center text-gray-600 mb-2">
                    ...
                    <span>{hotel.location.area}, {hotel.location.city} - {hotel.location.pincode}</span>
                  </div>
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 text-lg font-semibold text-gray-700">
                      {hotel.ratings.average} ({hotel.ratings.count} reviews)
                    </span>
                  </div>
                </div>
              ...
              <div>
                {activeTab === 'about' && (
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-6">{hotel.about}</p>
                    <div className="grid grid-cols-3 gap-4">
                      <div className="bg-amber-50 p-4 rounded-lg">
                        <p className="text-sm text-gray-600 mb-1">Rooms</p>
                        <p className="text-2xl font-bold text-amber-600">{hotel.rooms}</p>
                      </div>
                      <div className="bg-amber-50 p-4 rounded-lg">
                        <p className="text-sm text-gray-600 mb-1">Min Capacity</p>
                        <p className="text-2xl font-bold text-amber-600">{hotel.capacity.min} guests</p>
                      </div>
                      <div className="bg-amber-50 p-4 rounded-lg">
                        <p className="text-sm text-gray-600 mb-1">Max Capacity</p>
                        <p className="text-2xl font-bold text-amber-600">{hotel.capacity.max} guests</p>
                      </div>
                    </div>
                  </div>
                )}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4 mt-4">
                        <div className="flex items-center space-x-2">
                          <svg className={`w-5 h-5 ${hotel.policies.parking ? 'text-amber-500' : 'text-red-500'}`} fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d={hotel.policies.parking ? "M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" : "M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z"} clipRule="evenodd" />
                          </svg>
                          <span className="text-gray-700">{hotel.policies.parking ? 'Parking Available' : 'No Parking'}</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <svg className={`w-5 h-5 ${hotel.policies.smoking ? 'text-amber-500' : 'text-red-500'}`} fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d={hotel.policies.smoking ? "M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" : "M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z"} clipRule="evenodd" />
                          </svg>
                          <span className="text-gray-700">{hotel.policies.smoking ? 'Smoking Allowed' : 'No Smoking'}</span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 sticky top-8">
              <div className="mb-6">
                ...
                {hotel.price.perPlate && (
                  <p className="text-gray-600">₹{hotel.price.perPlate}/plate</p>
                )}
              </div>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center justify-between py-3 border-b">
                  ...
                  <span className="font-semibold">{hotel.capacity.min} - {hotel.capacity.max}</span>
                </div>
                <div className="flex items-center justify-between py-3 border-b">
                ...
                <div className="flex items-center justify-between py-3 border-b">
                  ...
                  <span className="font-semibold">{hotel.location.city}</span>
                </div>
              </div>

              <button className="w-full bg-amber-600 text-white py-3 rounded-lg hover:bg-amber-700 transition-colors font-semibold mb-3">
                Book Now
              </button>
              <button className="w-full border-2 border-amber-600 text-amber-600 py-3 rounded-lg hover:bg-amber-50 transition-colors font-semibold">
                Request Callback
              </button>
              ...
              <div className="mt-6 pt-6 border-t">
                ...
                <div className="space-y-2">
                  {hotel.contactInfo.phone && (
                    <a href={`tel:${hotel.contactInfo.phone}`} className="flex items-center text-gray-600 hover:text-amber-600">
                      <svg className="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  {hotel.contactInfo.email && (
                    <a href={`mailto:${hotel.contactInfo.email}`} className="flex items-center text-gray-600 hover:text-amber-600">
                      <svg className="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  {hotel.contactInfo.website && (
                    <a href={`https://${hotel.contactInfo.website}`} target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-600 hover:text-amber-600">
                      <svg className="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
