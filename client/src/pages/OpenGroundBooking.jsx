...
function OpenGroundBooking() {
  ...
  const fetchOpenGrounds = async () => {
    try {
      ...
      console.error('Error fetching open grounds:', error);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen">
      ...
      <div 
        ...
        style={{
          backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=1600')"
        }}
      >
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <h1 className="text-5xl font-bold mb-4">Open Ground/Plot for Events</h1>
          <p className="text-xl">Spacious outdoor venues for grand celebrations</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Filter Open Grounds</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-800">
            {openGrounds.length} Open Grounds Found
          </h2>
        </div>
        ...
        ) : openGrounds.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {openGrounds.map((ground) => (
              <OpenGroundCard key={ground._id} ground={ground} />
            ))}
          </div>
        ) : (
          <div className="text-center py-16">
            <div className="text-6xl mb-4">😞</div>
            <h3 className="text-2xl font-bold text-gray-800 mb-2">No Open Grounds Found</h3>
...
export default OpenGroundBooking;
